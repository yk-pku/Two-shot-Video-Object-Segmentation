...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--semi_thres_upper', default = 0.9, type = float)
        ...
        # Phase2
        parser.add_argument('--phase2_train', default = -1, type = int)
        parser.add_argument('--phase2_start_update', default = 70000, type = int)
        parser.add_argument('--phase2_thres', default = 0.99, type = float)
        parser.add_argument('--phase2_root', default = '../vos_phase2')
        parser.add_argument('--phase2_yv', help='interinference results of yv')
        parser.add_argument('--phase2_davis', help='interinference results of davis')
        parser.add_argument('--update_pseudo_bank', default = -1, type = int)
        ...
        parser.add_argument('--yv_data', help='YouTubeVOS data to train')
        parser.add_argument('--davis_root', help='DAVIS data root', default='../DAVIS')
        parser.add_argument('--davis_data', help='DAVIS data to train')
